          ...
          <div className="d-flex flex-column mt-3">
            {artPiece.culture && (
              <div className="mb-3">
                ...
                <div className="value">{artPiece.culture}</div>
              </div>
            )}
            {artPiece.period && (
              <div className="mb-3">
                <div className="label">Period:</div>{" "}
                <div className="value">{artPiece.period}</div>
              </div>
            )}
            {artPiece.objectDate && (
              <div className="mb-3">
                <div className="label">Date:</div>{" "}
                <div className="value">{artPiece.objectDate}</div>
              </div>
            )}
            {artPiece.medium && (
              <div className="mb-3">
                <div className="label">Medium:</div>{" "}
                <div className="value">{artPiece.medium}</div>
              </div>
            )}
            {artPiece.dimensions && (
              <div className="mb-3">
            ...
            {artPiece.region && (
              <div className="mb-3">
                ...
                <div className="value">{artPiece.region}</div>
              </div>
            )}
